import getAllEmoji from '@/utils/getAllEmoji'
import { Popover } from 'antd'
import React, { useCallback, useState } from 'react'

const EmojiList = React.memo(function EmojiList({
  onSelect,
}: {
  onSelect: (emoji: { name: string; src: string }) => void
}) {
  const emojis = getAllEmoji()

  return (
    <div className="grid grid-cols-8 md:grid-cols-10 gap-4">
...
const ChatEmoji = ({
  ...
  onSelectEmoji: (emoji: { name: string; src: string }) => void
}) => {
